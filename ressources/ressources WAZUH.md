...
🔶 Présentation et architecture de Wazuh :  
   https://documentation.wazuh.com/current/getting-started/architecture.html  

🔰 𝗟𝗮𝗯 𝗦𝗲𝘁 𝘂𝗽  
🔶 Configuration de laboratoire tout-en-un Wazuh :  
   https://documentation.wazuh.com/current/quickstart.html  
🔶 Installation de Wazuh sur VirtualBox :  
   https://documentation.wazuh.com/current/deployment-options/virtual-machine/virtual-machine.html  
🔶 Installation de Wazuh sur Docker :  
...
🔶 Réponse aux incidents avec TheHive et Wazuh  
   https://wazuh.com/blog/using-wazuh-and-thehive-for-threat-protection-and-incident-response/  
🔶 Automatisation de la sécurité avec Shuffle et Wazuh  
   https://wazuh.com/blog/integrating-wazuh-with-shuffle/  

🔰 Chasse aux menaces  
🔶 À l'aide des données d'inventaire  
   https://wazuh.com/blog/detecting-threats-using-inventory-data/#detecting-a-new-network-interface  
🔶 Chasse aux menaces avec Wazuh FIM et Yara pour les terminaux Linux   
   https://medium.com/@ekeneejike/threat-hunting-with-wazuh-fim-and-yara-on-linux-endpoints-cf8f5b84ae6e  

Suivez Rajneesh G. sur LinKedin pour plus de contenu exceptionnel.  
